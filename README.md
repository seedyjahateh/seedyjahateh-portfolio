...
every route works with JavaScript disabled. 239 roadmap entries are browsable;
...
| **Seed catalog**          | All 239 projects, imported through the production schema, zero manual transformation   |
...
content/projects      the 239 seed manifests
...
- **239 records need authoring** before any can be published. Expected work, not a defect.
