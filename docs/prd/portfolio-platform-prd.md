...
| Virtualized views   | Performance UI workstream             | `apps/web/features/catalog/views`, view benchmarks                     | fixed row view, deterministic bento row packer, scroll/focus restoration     | free-form masonry, independent filter state                  |
